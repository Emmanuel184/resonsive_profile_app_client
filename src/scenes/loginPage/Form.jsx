...
const loginSchema = yup.object().shape({
    email: yup.string().email("Imvalid email").required(),
        ...
        {({
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    {isRegister && (
                        <>
                            ...
                            <TextField
                                ...
                                name="lastName"
                                error={Boolean(touched.lasttName) && Boolean(errors.lasttName)}
                ...
                <Box>
                    ...
                    >
                        {isLogin ? "Dont have an account? Sign up here." : "Already have an account? Click here!"}
                    </Typography>
                </Box>
            </form>
        )}
